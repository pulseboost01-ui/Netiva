...
const inputClass =
  "w-full px-4 py-3 rounded-xl bg-neutral-50 border border-black/10 text-neutral-900 text-sm placeholder-neutral-400 focus:outline-none focus:border-black/25 transition-colors";
...
export default function ContactFormPanel({ variant = "page" }: { variant?: Variant }) {
  ...
  const studioWhatsAppIntro = `https://wa.me/${siteConfig.phone.whatsappDigits}?text=${encodeURIComponent(
  ...
  const formCard = (
    <div className="p-6 md:p-8 rounded-2xl bg-[var(--muted)] border border-black/8">
        ...
        {submitted ? (
          ...
          >
            <motion.div
              ...
              className="w-14 h-14 rounded-full bg-[var(--accent)]/25 border border-black/10 flex items-center justify-center mb-4"
            >
              <Check size={22} className="text-neutral-900" />
            </motion.div>
            <h3 className="font-display mb-2 text-xl text-neutral-900">
              Routed to the studio inbox
            </h3>
            <p className="mx-auto max-w-sm text-neutral-600 text-sm">
          ...
          <motion.form key="form" onSubmit={handleSubmit} className="relative space-y-4">
            ...
            <div>
              <label className="block text-xs text-neutral-500 uppercase tracking-wider mb-2">Company</label>
              <input
                type="text"
            ...
            <motion.button
              ...
              className="w-full py-4 bg-[var(--accent)] text-neutral-900 font-semibold rounded-xl flex items-center justify-center gap-2 transition-colors disabled:opacity-70"
            >
              {loading ? (
                <>
                  <motion.div
            ...
            <p className="text-center text-xs text-neutral-500">I typically respond within 24 hours</p>
          </motion.form>
        )}
      </AnimatePresence>
    </div>
          ...
          {submitted ? (
            ...
            >
              <div className="mx-auto mb-5 flex h-14 w-14 items-center justify-center rounded-full border border-neutral-200 bg-neutral-50">
                <Check size={24} className="text-neutral-900" strokeWidth={2} />
              </div>
              <p className="text-lg font-semibold text-neutral-900">Thanks — routed to Netiva&apos;s inbox.</p>
              <p className="mt-2 text-sm text-neutral-600">
                We acknowledge within one business day. Continue on WhatsApp for async velocity or schedule a call with us.
              </p>
              {delivery ? (
                <InquiryDeliveryActions
                  whatsAppUrl={delivery.whatsAppUrl}
            ...
            <motion.div key="form" initial={{ opacity: 1 }} animate={{ opacity: 1 }}>
              ...
              <div className="mt-8 flex items-center gap-3">
                ...
                <div className="min-w-0">
                  ...
                  <a
                    ...
                    className="text-sm text-neutral-600 underline-offset-2 hover:text-neutral-950 hover:underline"
                  >
                    {siteConfig.email}
                  </a>
                  <div className="mt-3 flex flex-wrap gap-2 font-mono text-[11px] font-semibold uppercase tracking-[0.18em] text-neutral-600">
              ...
              <form onSubmit={handleSubmit} className="relative mt-10 space-y-5">
                ...
                <div>
                  ...
                  <div className="relative">
                    <select
                      ...
                      className={`${drawerFieldClass} cursor-pointer appearance-none pr-10 ${formState.budget ? "text-neutral-900" : "text-neutral-500"}`}
                    >
                ...
                <p className="pt-6 text-[13px] leading-relaxed text-neutral-500">
  ...
  return (
    <div className="grid md:grid-cols-2 gap-16 items-start">
      <div>
        <p className="text-xs uppercase tracking-widest text-neutral-600 font-medium mb-3">Contact</p>
        <h1 className="mb-6 text-5xl text-neutral-900 md:text-6xl">
          Let&apos;s build
          <br />
          <em>something great</em>
        </h1>
        <p className="text-neutral-600 text-base leading-relaxed mb-10 max-w-sm">
        ...
        <div className="space-y-4 mb-10">
          {[
            { icon: Mail, label: "Studio email", value: siteConfig.email, href: `mailto:${siteConfig.email}` },
            {
              icon: Phone,
              label: "Voice / GSM",
            ...
            <div key={label} className="flex items-center gap-4">
              <div className="w-10 h-10 rounded-xl bg-neutral-100 border border-black/8 flex items-center justify-center flex-shrink-0">
              ...
              <div>
                ...
                {onClick ? (
                  ...
                  external ? (
                    ...
                    <Link href={href} className="text-sm text-neutral-700 hover:text-neutral-900 transition-colors">
                      {value}
                    </Link>
                  ) : (
                    <a href={href} className="text-sm text-neutral-700 hover:text-neutral-900 transition-colors">
                      {value}
                    </a>
                  )
                ) : (
        ...
        <p className="text-xs text-neutral-500 uppercase tracking-wider mb-3">Follow along</p>
        <div className="flex items-center gap-2">
          {socialIcons.map(({ icon: Icon, href, label }) => (
            <motion.a
              ...
              whileTap={{ scale: 0.9 }}
              className="w-10 h-10 rounded-xl border border-black/10 flex items-center justify-center text-neutral-500 hover:text-neutral-900 hover:border-black/20 transition-all bg-[var(--card)]"
            >
              <Icon size={15} />
            </motion.a>
          ))}
